        ...
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                <div >
                    ...
                    <p className="text-white text-md lg:text-lg mt-5 ml-14">July, 2017 - December, 2021</p>
                    <p className="text-white text-md lg:text-lg mt-4 ml-14">Lakshmipur Polytechnic Institute, Lakshmipur</p>
                </div>
